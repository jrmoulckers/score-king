...
export const fluff: GameModule = {
  ...
  configFields: [
    ...
    {
      key: 'palifico',
      label: 'Palifico round',
      type: 'boolean',
      default: true,
      help: 'The first player down to one die triggers a Palifico round — a single fixed face and ones aren’t wild. Flourish only; we call it out at the table but it doesn’t change the tally.',
    },
  ],
  ...
  help: [
    ...
    'Palifico (toggle in setup): the first time a player drops to one die, that round',
    'fixes a single face and ones aren’t wild — we call it out at the table for you.',
    '',
