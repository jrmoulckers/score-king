...
4. No client secret (public client + PKCE). Any future credential must stay out of source under
   [`ENG-SEC-001`](https://github.com/jrmoulckers/engineering/blob/v0.15.2/principles/assurance/security-and-privacy.md#eng-sec-001).
...
[`v0.15.2` principles index](https://github.com/jrmoulckers/engineering/blob/v0.15.2/principles/index.json).
